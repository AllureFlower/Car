...
class Verification{
    ...
    public function init()
    {
        ...
        $this->ResourcesPath =  str_replace('\\','/',__DIR__).'/Code/'; 
        //背景图片存放目录 （Resources）
        $dir = './Public/Code/'.date('YmdH');  //被处理图片 存放目录（裁剪小图，错位背景图）
